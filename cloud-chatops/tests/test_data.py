...
MOCK_PR = PR(
    ...
    created_at=datetime.strptime("2024-11-15T07:33:56Z", "%Y-%m-%dT%H:%M:%SZ").replace(tzinfo=timezone.utc),
)
...
MOCK_MR = PR(
    ...
    created_at=datetime.fromisoformat("2024-12-15T07:33:56.000+00:00").replace(tzinfo=timezone.utc),
)
